  ...
  return (
    <GPSection title="Quick Menu" subtitle="필요한 기능만 빠르게">
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10 }}>
        {items.map((item) => (
          <GPCard key={item.key} onPress={item.onPress} style={{ flexBasis: '30%', flexGrow: 1, minWidth: 0 }} contentStyle={{ paddingVertical: 16, paddingHorizontal: 10, alignItems: 'center' }}>
